...
async function main() {
  ...
  const icons = [
    ...
    { name: "Transformer", svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6a3 3 0 0 1 0 6 3 3 0 0 1 0 6" /><path d="M20 6a3 3 0 0 0 0 6 3 3 0 0 0 0 6" /><line x1="10" y1="5" x2="10" y2="19" /><line x1="14" y1="5" x2="14" y2="19" /><path d="M2 6h2" /><path d="M2 18h2" /><path d="M20 6h2" /><path d="M20 18h2" /></svg>' },
    { name: "PCB", svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="18" rx="2" /><path d="M6 12h4l3-3h5" /><path d="M6 16h6l2 2h4" /><circle cx="6" cy="12" r="1" fill="currentColor" /><circle cx="6" cy="16" r="1" fill="currentColor" /><circle cx="18" cy="9" r="1" fill="currentColor" /><circle cx="18" cy="18" r="1" fill="currentColor" /></svg>' },
  ];
